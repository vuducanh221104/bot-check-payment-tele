...
async function replaceColor({ image, target, replace, tolerance = 0 }) {
  try {
...
async function cutBorder({ image, borderWidth = 5 }) {
  try {
    const jimpImage = await import_jimp.default.read(image);
    ...
    const croppedImage = jimpImage.crop(borderWidth, borderWidth, newWidth, newHeight);
...
var processAsync = __name((param1, param2, generatorFunction) => new Promise((resolve, reject) => {
  var handleResult = __name((result) => {
    try {
...
// WebAssembly Go runtime implementation
(() => {
  const ErrENOSYS = __name(() => {
  ...
  if (!globalThis.process) {
    globalThis.process = {
      getuid: __name(() => -1, "getuid"),
      getgid: __name(() => -1, "getgid"),
      geteuid: __name(() => -1, "geteuid"),
      getegid: __name(() => -1, "getegid"),
      pid: -1,
      ppid: -1
    };
  }
  ...
  globalThis.Go = class {
    constructor() {
      ...
      const setMemoryValue = __name((address, value) => {
        this.mem.setUint32(address + 0, value, true);
        this.mem.setUint32(address + 4, Math.floor(value / 4294967296), true);
      }, "setMemoryValue");

      const getValueFromMemory = __name((address) => {
      ...
      const setValueInMemory = __name((address, value) => {
      ...
      const getByteArrayFromMemory = __name((address) => {
      ...
      const getArrayFromMemory = __name((address) => {
        const startAddress = this.mem.getUint32(address + 0, true) + 4294967296 * this.mem.getInt32(address + 4, true);
        const length = this.mem.getUint32(address + 8, true) + 4294967296 * this.mem.getInt32(address + 12, true);
      ...
      const getStringFromMemory = __name((address) => {
        const startAddress = this.mem.getUint32(address + 0, true) + 4294967296 * this.mem.getInt32(address + 4, true);
        const length = this.mem.getUint32(address + 8, true) + 4294967296 * this.mem.getInt32(address + 12, true);
        return TextDecoderUnicode.decode(new DataView(this._inst.exports.mem.buffer, startAddress, length));
      }, "getStringFromMemory");
      ...
      this.importObject = {
        _gotest: {
          add: __name((a, b) => a + b, "add")
        },
        gojs: {
          "runtime.wasmExit": __name((input) => {
          ...
          "runtime.wasmWrite": __name((address) => {
            ...
            fs.writeSync(fileDescriptor, new Uint8Array(this._inst.exports.mem.buffer, dataAddress, dataLength));
          }, "runtime.wasmWrite"),

          "runtime.resetMemoryDataView": __name((_0x1fc0dd) => {
            this.mem = new DataView(this._inst.exports.mem.buffer);
          }, "runtime.resetMemoryDataView"),

          "runtime.nanotime1": __name((_0x5843c4) => {
            setMemoryValue(8 + (_0x5843c4 >>>= 0), 1e6 * (timeDifference + performance.now()));
          }, "runtime.nanotime1"),

          "runtime.walltime": __name((_0x431dd5) => {
            _0x431dd5 >>>= 0;
            const _0x2d1628 = (new Date()).getTime();
            setMemoryValue(_0x431dd5 + 8, _0x2d1628 / 1e3);
            this.mem.setInt32(_0x431dd5 + 16, _0x2d1628 % 1e3 * 1e6, true);
          }, "runtime.walltime"),

          "runtime.scheduleTimeoutEvent": __name((_0x40be90) => {
            _0x40be90 >>>= 0;
            const _0x4d23db = this._nextCallbackTimeoutID;
            this._nextCallbackTimeoutID++;
            this._scheduledTimeouts.set(_0x4d23db, setTimeout(() => {
          ...
          "runtime.clearTimeoutEvent": __name((_0x4d392b) => {
            const _0x157834 = this.mem.getInt32(8 + (_0x4d392b >>>= 0), true);
            clearTimeout(this._scheduledTimeouts.get(_0x157834));
            this._scheduledTimeouts.delete(_0x157834);
          }, "runtime.clearTimeoutEvent"),

          "runtime.getRandomData": __name((_0xfc09b6) => {
            crypto.getRandomValues(getByteArrayFromMemory(8 + (_0xfc09b6 >>>= 0)));
          }, "runtime.getRandomData"),

          "syscall/js.finalizeRef": __name((_0x5edca4) => {
            const _0x57d4fc = this.mem.getUint32(8 + (_0x5edca4 >>>= 0), true);
          ...
          "syscall/js.stringVal": __name((_0x11c7ea) => {
            setValueInMemory(24 + (_0x11c7ea >>>= 0), getStringFromMemory(_0x11c7ea + 8));
          }, "syscall/js.stringVal"),

          "syscall/js.valueGet": __name((_0x3c119c) => {
            _0x3c119c >>>= 0;
            const _0x57d3f0 = Reflect.get(getValueFromMemory(_0x3c119c + 8), getStringFromMemory(_0x3c119c + 16));
            _0x3c119c = this._inst.exports.getsp() >>> 0;
            setValueInMemory(_0x3c119c + 32, _0x57d3f0);
          }, "syscall/js.valueGet"),

          "syscall/js.valueSet": __name((_0x2df90d) => {
            _0x2df90d >>>= 0;
            Reflect.set(getValueFromMemory(_0x2df90d + 8), getStringFromMemory(_0x2df90d + 16), getValueFromMemory(_0x2df90d + 32));
          }, "syscall/js.valueSet"),

          "syscall/js.valueDelete": __name((_0x5c6169) => {
            _0x5c6169 >>>= 0;
            Reflect.deleteProperty(getValueFromMemory(_0x5c6169 + 8), getStringFromMemory(_0x5c6169 + 16));
          }, "syscall/js.valueDelete"),

          "syscall/js.valueIndex": __name((_0xd5cf7e) => {
            setValueInMemory(
              24 + (_0xd5cf7e >>>= 0),
              Reflect.get(
          ...
          "syscall/js.valueSetIndex": __name((_0x1b938f) => {
            _0x1b938f >>>= 0;
            Reflect.set(
          ...
          "syscall/js.valueCall": __name((_0x38baf6) => {
            _0x38baf6 >>>= 0;
            try {
              const _0xb55714 = getValueFromMemory(_0x38baf6 + 8);
              const _0x4b45ac = Reflect.get(_0xb55714, getStringFromMemory(_0x38baf6 + 16));
          ...
          "syscall/js.valueInvoke": __name((_0x19f35b) => {
            _0x19f35b >>>= 0;
            try {
          ...
          "syscall/js.valueNew": __name((_0x275c5e) => {
            _0x275c5e >>>= 0;
            try {
          ...
          "syscall/js.valueLength": __name((_0x2cc204) => {
            setMemoryValue(16 + (_0x2cc204 >>>= 0), parseInt(getValueFromMemory(_0x2cc204 + 8).length));
          }, "syscall/js.valueLength"),

          "syscall/js.valuePrepareString": __name((_0x57c513) => {
            _0x57c513 >>>= 0;
            const _0xe5ad3d = TextEncoderUnicode.encode(String(getValueFromMemory(_0x57c513 + 8)));
            setValueInMemory(_0x57c513 + 16, _0xe5ad3d);
            setMemoryValue(_0x57c513 + 24, _0xe5ad3d.length);
          }, "syscall/js.valuePrepareString"),

          "syscall/js.valueLoadString": __name((_0xd20694) => {
            const _0x1bcf7e = getValueFromMemory(8 + (_0xd20694 >>>= 0));
            getByteArrayFromMemory(_0xd20694 + 16).set(_0x1bcf7e);
          }, "syscall/js.valueLoadString"),

          "syscall/js.valueInstanceOf": __name((_0x515e20) => {
            this.mem.setUint8(
              24 + (_0x515e20 >>>= 0),
          ...
          "syscall/js.copyBytesToGo": __name((_0x3b040d) => {
            const _0xcf50d7 = getByteArrayFromMemory(8 + (_0x3b040d >>>= 0));
          ...
          "syscall/js.copyBytesToJS": __name((_0x2c7dbd) => {
    ...
    run(_0x3a3ab2) {
      return processAsync(this, null, function* () {
        ...
        const _0x17ab00 = __name((_0x592ac2) => {
...
var OCRModel = class {
  ...
  async loadModel() {
    if (!(0, import_fs.existsSync)(this.modelPath))
      await this.downloadOnnxModel();
    this.session = await ort.InferenceSession.create(this.modelPath);
  }

  async predict(imageBuffer) {
    const processedImage = await (0, import_sharp.default)(imageBuffer)
      .grayscale()
      .resize(160, 50)
      .raw()
      .toBuffer();
...
var TesseractUtils = class {
  ...
  static async cleanImage(image) {
    ...
    image = await cutBorder({ image, borderWidth: 1 });
    return image;
  }
...
var WasmUtils = class {
  ...
  static async downloadWasm() {
    const wasm = await (0, import_undici2.request)(
...
var MB = class {
  ...
  constructor(data) {
    ...
    if (data.preferredOCRMethod)
      this.preferredOCRMethod = data.preferredOCRMethod;
    if (data.customOCRFunction)
      this.customOCRFunction = data.customOCRFunction;
    if (data.saveWasm)
      this.saveWasm = data.saveWasm;
  }
  ...
  async recognizeCaptcha(image) {
    switch (this.preferredOCRMethod) {
      case "default":
        ...
        if (modelPredictedCaptcha.length !== 6)
          return null;
  ...
  const balanceData = await this.mbRequest({
    path: "/api/retail-accountms/accountms/getBalance",
    json: {}  // Empty object - mbRequest will add required fields
  });
  ...
  if (balanceData.acct_list && Array.isArray(balanceData.acct_list)) {
  ...
  if (balanceData.internationalAcctList && Array.isArray(balanceData.internationalAcctList)) {
  ...
  async getTransactionsHistory(data) {
    if (
      (0, import_moment2.default)().day() - (0, import_moment2.default)(data.fromDate, "D/M/YYYY").day() > 90 ||
      (0, import_moment2.default)().day() - (0, import_moment2.default)(data.fromDate, "D/M/YYYY").day() > 90
    )
      throw new Error("Date formatting error: Max transaction history must be shorter than 90 days!");

    if ((0, import_moment2.default)(data.fromDate, "DD/MM/YYYY").day() - (0, import_moment2.default)(data.toDate, "D/M/YYYY").day() > 90)
      throw new Error("Date formatting error: Max transaction history must be shorter than 90 days!");
    ...
    if (!historyData || !historyData.transactionHistoryList)
      return;
